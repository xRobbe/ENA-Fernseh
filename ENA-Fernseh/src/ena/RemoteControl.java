...
public class RemoteControl {
	...
	private final static JButton btnRemotePiPSwitch = new JButton();
	private final static JButton btnRemotePiPActivate = new JButton();
	private final static JButton btnRemoteTimeshiftStop = new JButton();
	private final static JButton btnRemoteTimeshiftBackwards = new JButton();
	private final static JButton btnRemoteTimeshiftPlayPause = new JButton();
	private final static JButton btnRemoteTimeshiftForwards = new JButton();
	...
	private void initialize() {
		...
		tableRemoteStations.setModel(new DefaultTableModel(new Object[][] {
				{ "1", "ARD" }, { "2", "ZDF" }, { "3", "RTL" },
				{ "4", "SAT1" }, { "5", "Pro7" }, }, new String[] { "Channel",
				"Name" }) {
		...
		btnRemoteTimeshiftBackwards.setIcon(new ImageIcon(RemoteControl.class.getResource("/picture/p_fback.png")));
		btnRemoteTimeshiftBackwards.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
			}
		});
		btnRemoteTimeshiftBackwards.setFocusPainted(false);
		btnRemoteTimeshiftBackwards.setToolTipText("Rewind Timeshift");
		btnRemoteTimeshiftBackwards.setBounds(97, 552, 77, 77);
		panelRemoteControl.add(btnRemoteTimeshiftBackwards);
	...
	public void updateScreen(){
		...
		case 0:
			...
			btnRemoteTimeshiftBackwards.setVisible(false);
		...
		case 1:
			...
			btnRemoteTimeshiftBackwards.setVisible(true);
