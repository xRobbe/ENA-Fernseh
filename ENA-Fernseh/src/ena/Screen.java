...
public class Screen {
	...
	private void initialize() {
		...
		// Panel f�r Willkommenbildschirm
		...
		// Ladebalken f�r Willkommenbildschirm
		...
		// Progressbar f�r die Timeshift Funktion
		...
		// ScrollPane f�r die Senderliste an der linken Seite (ausgeblendet)
		...
		// Senderliste f�r das ScrollPane
		...
		/*
		 * f�r Debuggen JButton btnSenderliste = new JButton("Senderliste");
		...
		// Standart Bilder und Sender f�r das Haupt- und PiP-Fenster
	...
	// Anpassung der Gr��e des Bildes f�r die Fenster
	...
	// l�sst panel auf der y-Achse bewegen
	...
	// l�sst panel auf der x-Achse bewegen
	...
	// das Bild in dem Haupt- oder PiP-Fenster �ndern
